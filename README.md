...
3. Open the extracted files and copy the DataFiles folder and OKAC.ese file. Go to your current sector file folder for OKAC and replace the DataFiles and .ese file with the ones you just copied. 
